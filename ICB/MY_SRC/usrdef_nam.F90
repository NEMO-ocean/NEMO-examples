MODULE usrdef_nam
   ...
   !                                         !!* namusr_def namelist *!!
   REAL(wp), PUBLIC ::   rn_dx, rn_dy         !: horizontal resolution   [degrees]
...
902   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namusr_def in configuration namelist' )
      ...
      kk_cfg = INT( rn_e3 )
      !
      ! Global Domain size:  ICB domain is  15° x 10° x 900 m
      kpi = 40 + 2     ! add 2 for t-point in the east  & west  coasts
      kpj = 40 + 2     !     -        -           north & south   -
      ...
      IF(lwp) THEN
         ...
         WRITE(numout,*) '         zonal      resolution                 rn_dx    = ', rn_dx   , ' meters '
         WRITE(numout,*) '         meridional resolution                 rn_dy    = ', rn_dy   , ' meters '
         WRITE(numout,*) '         vertical   resolution                 rn_e3    = ', rn_e3   , ' meters'
         WRITE(numout,*) '      ICB domain = 15° x 10° x 900 m'
